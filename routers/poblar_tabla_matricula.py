...
@poblar_tabla_matricula_router.post("/api2/poblar_tabla_matricula_router/{fid_usuario}", response_model=int,tags=['Base de Datos'],dependencies=[Depends(JWTBearer())])
