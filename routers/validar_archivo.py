...
load_dotenv()
API = os.getenv("UL_API")

@verificacion_inicial_archivo.post("/Validar_archivo/", tags=['Validacion Archivo'], dependencies=[Depends(JWTBearer())])
def verificar_archivo(nombre_archivo: str):
    ...
    """
    ruta = f"{API}/static/temp_files/{nombre_archivo}"
