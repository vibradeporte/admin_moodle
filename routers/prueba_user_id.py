...
def calcular_fechas_matricula(row):
    ...
    # Calcular el número de días entre timestart y timeend
    nro_dias_de_matriculas = (fecha_fin_curso - fecha_inicio_matricula).days
    
    return pd.Series([timestart, timeend, nro_dias_de_matriculas], index=['timestart', 'timeend', 'NRO_DIAS_DE_MATRICULAS'])
